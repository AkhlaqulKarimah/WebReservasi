...
<body>
	...
	<table border="2">
		...
		<?php
		// $id = $_GET['id'];
		$query = "SELECT * FROM tbl_transaksi INNER JOIN tbl_reservasi ON tbl_transaksi.id_reservasi = tbl_reservasi.id_reservasi 
			INNER JOIN tbl_menu ON tbl_transaksi.id_menu = tbl_menu.id_menu 
			WHERE tbl_reservasi.id_reservasi = '$id'";
